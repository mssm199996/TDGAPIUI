 ...
 * @author mssm1996
 */
public class AretePondere extends Arete {
    
    public AretePondere(String label, double poid, Sommet sommetGauche, Sommet sommetDroit) {
    ...
    public boolean equals(Object o){
        if(o instanceof AretePondere)
            return super.equals(o) && this.ponderationValue.getValue().getPoid() == ((AretePondere) o).ponderationValue
                    .getValue().getPoid();
        return false;
    }
    ...
    public int compareTo(Object o){
        if(o instanceof AretePondere)
            return (int)(this.getPoid() - ((AretePondere) o).getPoid()) == 0 ? super.compareTo(o) : (int)(this.getPoid() - ((AretePondere) o).getPoid());
        return 0;
    }
}
